                                ...
                                if(isset($_POST['answer']))
                                {
                                    if($database->getRowCount() == 0)
                                    {
                                        ...
                                        else 
                                        {
                                            ...
                                            $database->processQuery("INSERT INTO `recoveries` VALUES (null, ?, ?, ?, ?, ?, ?, ?, ?, CURDATE())", array($user->getUserId($_COOKIE['user']), 0, $answers[0], $answers[1], $answers[2], $answers[3], $answers[4], $answers[5]), false);
