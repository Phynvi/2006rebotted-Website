...
elseif(isset($_POST['message']))
{
    ...
    else
    {
        ...
        //insert report
        $database->processQuery("INSERT INTO `threads` VALUES (null, ?, ?, ?, ?, NOW(), ?, NOW(), ?, '', NOW(), ?, '0', '0', '0', '', '0', ?, '0', '0', '')", array($config['reportforum'], 'Report By: '.$username, $content, 'Report', qfc($database), $username, $_SERVER['REMOTE_ADDR'], time()), false);
