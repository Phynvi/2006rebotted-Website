...
//let's also make sure they have the right permissions to view the forum, and it's valid
if(!ctype_digit($f) || $forum->canView($f, $rank) == false) $base->redirect('index.php');
...
//get current page
(!ctype_digit($_GET['page']) || $_GET['page'] > $pages || $_GET['page'] == 0) ? $page = 1 : $page = $_GET['page'];
